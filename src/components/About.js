    ...
    <div id="About-Me">
      <div className="container about-me">
        ...
        <p className="text-center animated about-me-text">
          Hello, I am Yosuke Kono. I am a passionate web developer focused on
          creating innovative software solutions. I hold a Master's degree in
          Information Technology from Queensland University of Technology and
          currently work as a Web Developer at Fonseka. My journey has equipped
          me with a solid foundation in both front-end and back-end
